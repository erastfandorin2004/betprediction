...
export function buildLvsSystemPrompt(): string {
  return (
    ...
    'только при явных основаниях (пенальти, стандарты). Для каждого игрока укажи его позицию на русском ' +
...
{"outcome":"1","probs":{"win1":0.0,"draw":0.0,"win2":0.0},"score":{"home":0,"away":0},"scorers":[{"name":"Имя Фамилия","team":"home","position":"нападающий","probability":0.0},{"name":"...","team":"away","position":"полузащитник","probability":0.0},{"name":"...","team":"home","position":"нападающий","probability":0.0}],"rationale":"3-5 предложений на русском","keyFactors":["...","...","..."],"confidence":0.0}
...
- "scorers" — РОВНО 3 игрока, ТОЛЬКО из стартовых составов выше, "team": "home" или "away", "position" — позиция игрока на русском (нападающий/полузащитник/защитник/вратарь), выбор с учётом позиции, "probability" — шанс гола (0..1).
